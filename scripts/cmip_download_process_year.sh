...
time python ${main_dir}/casas_web_portal/manage.py download_cmip6 $YEAR

time python ${main_dir}/casas_web_portal/manage.py create_txt_cmip6 --dir /opt/casas_data/ $YEAR

rm -f /opt/casas_data/data/era5/*/*$YEAR*.nc
